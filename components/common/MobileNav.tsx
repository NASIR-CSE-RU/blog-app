                                ...
                                <li className="_mobile_navigation_bottom_item">
                                    <a href="/feed"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="27" fill="none"
                                            viewBox="0 0 24 27">
                                            <path className="_mobile_svg" fill="#000" fillOpacity=".6" stroke="#666666"
                                                strokeWidth="1.5"
                                            ...
                                            <path fill="#fff" stroke="#fff" strokeLinecap="round"
                                ...
                                <li className="_mobile_navigation_bottom_item">
                                    <a href="friend-request.html" className="_mobile_navigation_bottom_link">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="20" fill="none"
                                            viewBox="0 0 27 20">
                                            <path className="_dark_svg" fill="#000" fillOpacity=".6"
                                                fillRule="evenodd"
                                    ...
                                    <form action="/mobileMenu.html">
                                        <button type="submit" className="_header_mobile_btn_link"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14"
                                                ...
                                                <path stroke="#666" strokeLinecap="round" strokeWidth="1.5"
