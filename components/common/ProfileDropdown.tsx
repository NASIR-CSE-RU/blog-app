...
export default function ProfileDropdown({ userName }: ProfileDropdownProps) {
  ...
  return (
    <div className="_header_nav_profile" ref={containerRef}>
      ...
      <button
        className="_header_nav_dropdown d-flex align-items-center border-0 bg-transparent p-0"
        type="button"
        ...
        <ul className="_nav_dropdown_list">
          ...
          <li className="_nav_dropdown_list_item">
            <form action={logoutAction}>
              <button type="submit" className="_nav_dropdown_link w-100 text-start border-0 bg-transparent">
                <div className="_nav_drop_info">
                  <span>
